<!-- Quatrième partie — PLANIFIER ET DÉCIDER -->

# Chapitre 7 — Fixer le cap

## Commencez par savoir le dire

Avant de parler de plans, un exercice. Imaginez que vous croisez, dans un ascenseur ou dans un couloir, la personne qui pourrait financer votre projet, vous louer un local ou devenir votre premier gros client. Vous avez trente secondes. Que dites-vous ?

Cet exercice porte un nom : le *discours d’ascenseur*. Il paraît anecdotique, il ne l’est pas. Un porteur de projet incapable d’exposer son affaire en trente secondes n’a pas un problème d’élocution : il a un problème de clarté. S’il ne sait pas dire ce qu’il fait, pour qui, et pourquoi cela vaut d’être payé, c’est que son plan n’existe pas encore.

Un bon discours d’ascenseur tient en quatre éléments :
1. **Le problème** que vous résolvez, et pour qui.
2. **Votre réponse**, en une phrase, sans jargon.
3. **Ce qui vous distingue** de ceux qui font déjà quelque chose de proche.
4. **Ce que vous demandez** à votre interlocuteur : un rendez-vous, un essai, une mise en relation. Jamais rien de vague.
...
C’est ici que l’initiative personnelle, dont nous avons parlé au chapitre 2, retrouve toute son importance. Se lancer soi-même, anticiper, franchir les obstacles : ces trois habitudes sont ce qui transforme un plan en activité. Et l’inverse est également vrai — les objectifs facilitent l’autodémarrage. Quand vous savez précisément ce qui reste à faire, vous n’avez plus besoin de vous motiver : vous exécutez la prochaine ligne.

## Fixer des objectifs SMART

Un objectif utile n’est pas une intention. « Développer mon entreprise » n’est pas un objectif : c’est un souhait. Pour être exploitable, un objectif doit être SMART, c’est-à-dire :
- **S**imple — pas trop large. Dites précisément ce que vous voulez faire.
- **M**esurable — un nombre, une quantité, un montant, qui permette de suivre le progrès.
- **A**mbitieux — stimulant, il doit vous obliger à vous dépasser.
- **R**éaliste — vous pouvez réellement y arriver avec les moyens dont vous disposez.
- **T**emporel — limité dans le temps, avec une date précise.[^1]

Comparez : « augmenter mes ventes » d’un côté ; « passer de 40 à 60 commandes par mois d’ici au 31 octobre » de l’autre. Le premier ne se vérifie jamais. Le second se vérifie le 31 octobre, et vous saurez ce jour-là si votre méthode fonctionne.

Ambitieux et réaliste ne s’opposent pas : ils se tiennent. Un objectif trop facile ne produit aucun effort ; un objectif hors d’atteinte produit du découragement, puis l’abandon. Visez ce qui vous oblige à changer quelque chose dans votre manière de travailler, sans exiger des moyens que vous n’aurez pas.
...
## Gardez la trace de vos objectifs

Un objectif que l’on garde en tête s’efface au premier imprévu. Écrivez-le. Notez-le dans un cahier, affichez-le, inscrivez l’échéance dans votre calendrier ou votre téléphone. Revenez-y à date fixe — chaque semaine, à la même heure.
...
- Si vous ne savez pas exposer votre projet en trente secondes, votre plan n’est pas encore clair.
- Planifier, c’est répondre à « quoi, dans quel ordre » — pas imaginer l’entreprise dans cinq ans.
- Un objectif utile est simple, mesurable, ambitieux, réaliste et daté.
- Trois horizons emboîtés : l’année, le trimestre, la semaine. Ce qui ne remonte à rien est de l’agitation.
- Deux ou trois priorités, pas dix. La dispersion ressemble à de la prudence et n’en est pas.
- Écrivez vos objectifs et relisez-les au moment où vous rencontrez un obstacle.
- Face à une difficulté, changez le plan ; face à une preuve que l’objectif était faux, changez l’objectif.
