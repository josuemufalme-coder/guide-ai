...
# Chapitre 1 — Développer une vision pour son entreprise

## Ce qu’est une vision

Une vision est une idée simple, tournée vers l’avenir, qui dit ce que votre entreprise veut devenir et ce à quoi elle sert. Elle porte vos valeurs et celles de l’entreprise, elle a une charge émotionnelle, et elle décrit une image idéale : non pas ce que vous êtes, mais ce que vous voulez être.

Elle n’est ni un objectif ni un slogan publicitaire. Un objectif se mesure et s’atteint ; une vision oriente sans jamais être tout à fait atteinte. Un slogan s’adresse au client ; une vision s’adresse d’abord à ceux qui construisent l’entreprise avec vous — et à vous-même.

## À quoi elle sert réellement

Entreprendre suppose d’obtenir des choses que vous n’avez pas : un financement, un équipement, un local, un partenaire, des employés compétents, la confiance d’un premier client. Rien de tout cela ne s’obtient par la seule démonstration technique. Il faut convaincre, et souvent inspirer.

Une vision forte est ce qui donne envie à d’autres de vous suivre. Un bailleur finance un projet qu’il comprend et qui l’intéresse ; un employé qualifié accepte un salaire modeste s’il croit à ce qui se construit ; un partenaire s’engage quand il voit où l’on va.

Elle a aussi une fonction interne, moins visible et tout aussi utile : elle vous tient. Les mois difficiles, quand la trésorerie est vide et que les résultats tardent, la vision est ce qui distingue une mauvaise passe d’un échec.

## Comment la formuler

Une bonne vision est :
- **Brève et claire** — environ sept mots. Si elle ne tient pas en une phrase, elle n’est pas encore une vision.
- **Créative et propre à vous** — pas une formule interchangeable qui conviendrait à n’importe quelle entreprise.
- **Inspirante** — elle doit produire un effet sur celui qui l’entend.
...
4. Nommez une décision concrète que cette vision vous oblige à prendre — ou à refuser — dans les trois prochains mois.
:::

## Ce qu’il faut retenir
- La vision dit ce que l’entreprise veut devenir ; l’objectif dit ce qu’elle doit atteindre cette année.
- Elle sert à obtenir des ressources et des soutiens, et à tenir dans les périodes difficiles.
- Brève, propre à vous, inspirante, tournée vers l’avenir.
- Une vision qui conviendrait à n’importe quelle entreprise n’en est pas une : elle doit exclure quelque chose.
- Elle se prouve par des décisions, pas par une plaque au mur.
