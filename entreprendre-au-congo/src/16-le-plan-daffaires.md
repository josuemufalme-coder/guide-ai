<!-- Huitième partie — LE PLAN D’AFFAIRES -->

# Chapitre 16 — Le plan d’affaires

## Ce qu’il est vraiment

Le plan d’affaires n’est pas un document administratif que l’on rédige pour obtenir un financement. C’est **la synthèse de tout ce que ce livre a fait construire** : votre vision, votre marché, votre offre, votre positionnement, vos prix, votre organisation et vos chiffres, rassemblés dans un ensemble cohérent.

Sa première utilité est pour vous. L’exercice oblige à mettre côte à côte des éléments que l’on garde habituellement séparés — et c’est en les rapprochant qu’on découvre les incohérences : un volume de ventes qui suppose une capacité de production que vous n’avez pas, un prix qui ne couvre pas des charges pourtant écrites deux pages plus loin, un besoin de financement calculé sans le fonds de roulement.
...
- **Des prévisions sans justification.** « Nous vendrons 500 unités par mois » n’a aucune valeur si l’on ne sait pas d’où vient ce chiffre. Expliquez toujours votre méthode de calcul : c’est elle qu’on évalue, pas le résultat.
- **Une croissance trop belle.** Des courbes qui montent régulièrement, sans mois creux ni incident, signalent un plan qui n’a pas été confronté au réel.
- **L’absence de salaire du dirigeant** dans les charges. Un lecteur averti le repère immédiatement, et cela discrédite tous vos autres chiffres.
- **L’oubli du fonds de roulement.** Demander le financement d’une machine sans le stock ni la trésorerie nécessaires pour la faire tourner est l’erreur la plus fréquente.
- **Un document trop long.** Vingt pages bien tenues valent mieux que soixante. Ce qui est essentiel doit être trouvable en cinq minutes.

## Un plan vit

Un plan d’affaires n’est pas un document que l’on écrit une fois et que l’on range. Reprenez-le au moins une fois par an, et à chaque changement significatif : un nouveau produit, un nouveau marché, une nouvelle demande de financement.
...
- Le plan d’affaires est d’abord un outil pour vous : il révèle les incohérences.
- Huit parties, dont la plus scrutée est le plan de trésorerie mensuel.
- Justifiez toujours vos chiffres par votre méthode de calcul.
- N’omettez ni votre salaire, ni le fonds de roulement, ni les risques.
- Écrivez-le vous-même. Vous devrez le défendre.
- Reprenez-le chaque année et comparez-le au réel.
